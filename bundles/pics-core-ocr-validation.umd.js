(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/router'), require('rxjs/operators'), require('@angular/common/http'), require('rxjs/add/operator/map'), require('rxjs/internal/observable/throwError'), require('rxjs/internal/operators'), require('ngxf-uploader'), require('primeng/card'), require('angular-formio')) :
    typeof define === 'function' && define.amd ? define('@pics-core/ocr-validation', ['exports', '@angular/core', 'rxjs', '@angular/router', 'rxjs/operators', '@angular/common/http', 'rxjs/add/operator/map', 'rxjs/internal/observable/throwError', 'rxjs/internal/operators', 'ngxf-uploader', 'primeng/card', 'angular-formio'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["pics-core"] = global["pics-core"] || {}, global["pics-core"]["ocr-validation"] = {}), global.ng.core, global.rxjs, global.ng.router, global.rxjs.operators, global.ng.common.http, global.rxjs["add/operator/map"], global.rxjs["internal/observable/throwError"], global.rxjs["internal/operators"], global.ngxfUploader, global.i3, global.i4));
})(this, (function (exports, i0, rxjs, i1, operators$1, i1$1, map, throwError, operators, ngxfUploader, i3, i4) { 'use strict';
    ...
    var OcrValidationService$1 = /** @class */ (function () {
        function OcrValidationService() {
        }
        return OcrValidationService;
    }());
    OcrValidationService$1.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationService$1, deps: [], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    OcrValidationService$1.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationService$1, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationService$1, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    ***************************************************************************** */
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrvalidationComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.Injector }, { type: OcrValidationService }, { type: DataStoreService }]; }, propDecorators: { formIO: [{
                    type: i0.ViewChild,
                    args: ['formIO']
                }], formResponseData: [{
                    type: i0.Input
    ...
    var OcrValidationComponent = /** @class */ (function () {
        function OcrValidationComponent(permissionStore, _storeservice) {
    ...
    OcrValidationComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationComponent, deps: [{ token: PermissionStore }, { token: DataStoreService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    OcrValidationComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: OcrValidationComponent, selector: "ocr-validation", inputs: { RBACORG: "RBACORG", PERMISSION: "PERMISSION", ocrEvent: "ocrEvent" }, ngImport: i0__namespace, template: "\n    <lib-ocrvalidation></lib-ocrvalidation>\n  ", isInline: true, components: [{ type: OcrvalidationComponent, selector: "lib-ocrvalidation", inputs: ["formResponseData", "currenttemplateResult", "submitionData"], outputs: ["ocrResponse"] }] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationComponent, decorators: [{
                type: i0.Component,
                args: [{
    ...
    var OcrValidationModule = /** @class */ (function () {
        function OcrValidationModule() {
        }
        return OcrValidationModule;
    }());
    OcrValidationModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    OcrValidationModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationModule, declarations: [OcrValidationComponent,
            OcrvalidationComponent], imports: [i3.CardModule,
            i4.FormioModule], exports: [OcrValidationComponent] });
    OcrValidationModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationModule, imports: [[
                i3.CardModule,
                i4.FormioModule
            ]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OcrValidationModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        declarations: [
                            OcrValidationComponent,
    ...
    exports.OcrValidationComponent = OcrValidationComponent;
    exports.OcrValidationModule = OcrValidationModule;
    exports.OcrValidationService = OcrValidationService$1;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=pics-core-ocr-validation.umd.js.map
